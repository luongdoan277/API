                                        ...
                                        <div className="col-lg-6 login">
                                            <div id="CustomerLoginForm" className="form-vertical">
                                                <form method="post" action="/" id="customer_login" >
                                                    ...
                                                    <input type="email" name="email" id="CustomerEmail" className="" autoCorrect="off" autoCapitalize="off" autoFocus=""/>
                                                    <label htmlFor="CustomerPassword">Password</label>
                                                    <input type="password" defaultValue={""} name="password" id="CustomerPassword" className=""/>
                                                    <div className="text-center">
                                                        <p>
                                                            <Link className="nav-link" to={'/'} id="RecoverPassword">Forgot your password?</Link>
                                                        </p>
                                                        <button type="submit" className="button-login" defaultValue={"Login"}>Login</button>
                                                        <p>
                                                            <Link className="nav-link" to={'/'} id="customer_register_link">Create account</Link>
                                                        </p>
                                                    </div>
                                                </form>
                                            </div>
